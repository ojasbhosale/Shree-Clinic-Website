...
const highlights = [
  {
    ...
    description: 'Tailored one-to-one support for each individual\'s unique recovery needs.',
  },
  {
    icon: Users,
    title: 'Exceptional Expertise',
    description: 'Compassionate specialist trained to the highest professional standards.',
  },
  {
    icon: Award,
    title: 'Beyond Standards',
    description: 'Exceeding clinical requirements with genuine care and deep respect.',
  },
  {
    icon: Shield,
    title: 'Home from Home',
    description: 'Safe, nurturing environments — clinic or doorstep, wherever you need us.',
  },
];
...
const quotes = [
  ...
  },
  {
    ...
    body: 'Led by Dr. Shraddha Dhongade (M.PT Neuro, Diploma in Yoga), our clinic specializes in yoga-based treatments and offers home visits, ensuring that expert care is accessible to everyone.',
  },
];
...
export default function Info() {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(160deg, #ffffff 0%, #FFF8F0 60%, #f7f9fc 100%)' }}
    >
      {/* Ambient orbs */}
      ...
      <div className="section-container relative" style={{ zIndex: 1 }}>
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="section-title mb-3">
            ...
            <span style={{ color: 'var(--venturi-coral)' }}>Recovery</span>
          </h2>
          ...
          <div className="relative">
            ...
            >
              ...
              <div
                ...
                style={{ background: 'linear-gradient(to top, rgba(26,32,44,0.4) 0%, transparent 55%)' }}
              />

              {/* Slide counter badge */}
              <div
                className="glass-panel absolute top-5 right-5 px-3 py-1.5 font-body text-white"
                style={{ borderRadius: '9999px', fontSize: '0.72rem', letterSpacing: '0.08em' }}
              >
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-3 shadow-xl transition-all duration-300 hover-lift border"
              style={{ borderColor: 'rgba(245,101,101,0.2)' }}
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-3 shadow-xl transition-all duration-300 hover-lift border"
              style={{ borderColor: 'rgba(245,101,101,0.2)' }}
            >
              ...
              {images.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: '0.5rem',
                    background: i === current ? 'var(--venturi-coral)' : 'rgba(255,255,255,0.6)',
                  }}
                />
              ))}
            </div>
            ...
            {quotes.map(({ accent, body }) => (
              ...
              >
                ...
                <p
                  ...
                  style={{ color: 'var(--venturi-orange)', fontSize: '0.82rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}
                >
                  {accent}
                </p>
                <p
                  className="font-editorial italic font-light leading-relaxed m-0"
                  style={{ color: 'var(--venturi-slate)', fontSize: 'clamp(0.95rem,1.5vw,1.1rem)' }}
                >
                  {body}
                </p>
              </div>
          ...
          {highlights.map(({ icon: Icon, title, description }, i) => (
            ...
            >
              ...
              <div>
                ...
                <p
                  className="font-body leading-relaxed m-0"
                  style={{ fontSize: '0.82rem', color: 'var(--venturi-slate)' }}
                >
                  {description}
                </p>
              </div>
